...
app.get('/posts/:postName', function(req, res){
  ...
  posts.forEach((post,index) => {    
    // chanllenge 18, 19 start
    reqPostTitle = _.lowerCase(req.params.postName);
    postTitle = _.lowerCase(post.postTitle);
    // postIndex = index;
    // if(reqPostTitle === postTitle){
    //   res.render('post',{
    //     posts: posts,
    //     reqPostTitle : reqPostTitle,
    //     postTitle : postTitle,
    //     postIndex : postIndex,
    //   })
      if(reqPostTitle === postTitle){
